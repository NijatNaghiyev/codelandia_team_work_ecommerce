...
import 'package:codelandia_team_work_ecommerce/get_x/state/visible_get_x.dart';
        ...
        child: Stepper(
          ...
          onStepContinue: () {
            if ((currentStep == 0 &&
                ...
                (currentStep == 1 && (city == null || address.text.isEmpty))) {
                  ...
                  : showDialog(
                      ...
                      builder: (context) {
                        Timer(
                          ...
                          () {
                            setState(() {});
                            visibleController.isVisible.value = true;
                          },
                        );
                        return Card(
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Obx(() {
                                  return Visibility(
                                    visible: visibleController.isVisible.value,
                                    child: OutlinedButton(
                                      onPressed: () {
                                        visibleController.isVisible.value =
                                            false;
